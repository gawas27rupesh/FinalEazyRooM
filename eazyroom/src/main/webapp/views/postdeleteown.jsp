   ...
   <c:forEach items="${eazy }" var="e">
    <tr class="text-white">
     ...
     <td>${e.utype }</td>
      ...
      <td>${e.gender }</td>
         <td>
      <a href="deleteown/${e.id }"><i class="fa-solid fa-trash text-danger" style="font-size:23px;"></i></a>
      <a href="updateown/${e.id }"><i class="fa-solid fa-pen-nib text-primary" style="font-size:23px;"></i></a>
     </td>
    </tr>
   </c:forEach>
