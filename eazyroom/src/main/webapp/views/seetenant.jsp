		...
		<div class="row">
			...
			<div class="col-md-8 offset-md-1 mt-3">
				...
				<h1 class="text-center mb-3 text-white ">
					<b>ALL TENANT POST IN YOUR CITY.</b>
				</h1>
				<div>
					<form action="seetenantgender" method="get">
						<table class="text-white">
							...
							<tr>
								<td><input type="hidden" name="city" value="${city}"
									required></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" id="gender" name="gender">
									<button type="submit" class="btn btn-outline-success">SEE
										ALL TENANT POST</button></td>
							</tr>
							<tr>
								<td><a href="pdftenant/${city}"
									class="btn btn-outline-primary">DOWNLOAD PDF</a></td>
							</tr>
						</table>
					</form>
				</div>
